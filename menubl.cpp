...
{system("color 71");
    ...
    for(int i=0; i<5; ++i){
        ...
        else { SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),113);
           cout<<menu[i]<<endl;}
}SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),113);
     ...
     cout<<"  Backspace == MENU                                                ESC == QUIT\n";
       while(true){      //8
        if(GetAsyncKeyState(VK_UP)!=0){PlaySound(TEXT("Menu.wav"),NULL,SND_ASYNC);Sleep(35);
            ...
            pointer+=1;
            if(pointer==3){
                pointer=0;SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),113);
                        }
        break;
        }
        else if(GetAsyncKeyState(VK_BACK)){
 ...
 for(int o=0; o<2; ++o){
  ...
  cout<<"\n\n      ========================\n\n\n\n\n\n\n\n\n\n";
     cout<<"  Backspace == MENU                                                ESC == QUIT\n";
       ...
       else if(GetAsyncKeyState(VK_BACK)){SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 113);
                system("cls");
            menubl mo;
            mo.menua();
        break;
...
system("cls");
 ...
 for(int f=0; f<5; ++f){
     ...
     cout<<"  Backspace == MENU                                                ESC == QUIT\n";
       while(true){ //33
        if(GetAsyncKeyState(VK_UP)!=0){PlaySound(TEXT("Menu.wav"),NULL,SND_ASYNC);Sleep(35);
            pointer-=1;SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),113);
            if(pointer== -1){
                pointer=4;
                            }
            break;
