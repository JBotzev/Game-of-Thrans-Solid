...
{system("color 3f");
    ...
    for(int i=0; i<5; ++i){
        if(i==pointer){
             SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),195);

            cout<<menu[i]<<endl;
                     }
        else { SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),63);
           cout<<menu[i]<<endl;}
}SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),63);
     ...
     cout<<"  Backspace == MENU                                                ESC == QUIT\n";
       while(true){      //8
        if(GetAsyncKeyState(VK_UP)!=0){PlaySound(TEXT("Menu.wav"),NULL,SND_ASYNC);Sleep(35);
            ...
            pointer+=1;
            if(pointer==3){
                pointer=0;SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),63);
                        }
        break;
        }
        else if(GetAsyncKeyState(VK_BACK)){
        ...
        break;
         ...
         if(GetAsyncKeyState(VK_RETURN)!=0){ PlaySound(TEXT("Menu.wav"),NULL,SND_ASYNC);Sleep(200);   //9
            switch(pointer){    //10
        case 0:
 ...
 for(int o=0; o<2; ++o){
  ...
  cout<<"\n\n      ========================\n\n\n\n\n\n\n\n\n\n";
     cout<<"  Backspace == MENU                                                ESC == QUIT\n";
       while(true){  //28
       ...
       else if(GetAsyncKeyState(VK_BACK)){SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 63);
                system("cls");
            menuaq mo;
            mo.menua();
        break;
        ...
        break;
          ...
          if(GetAsyncKeyState(VK_RETURN)!=0){PlaySound(TEXT("Menu.wav"),NULL,SND_ASYNC);Sleep(200);//29
            switch(pointer){//30
        case 0:
            { //31
...
system("cls");
 ...
 for(int f=0; f<5; ++f){
     ...
     cout<<"  Backspace == MENU                                                ESC == QUIT\n";
       while(true){ //33
        if(GetAsyncKeyState(VK_UP)!=0){PlaySound(TEXT("Menu.wav"),NULL,SND_ASYNC);Sleep(35);
            pointer-=1;SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),63);
            if(pointer== -1){
                pointer=4;
                            }
            break;
        ...
        case 2:{system("CLS");system("color a");
                menuf mo;
                mo.menua();
                }break;
